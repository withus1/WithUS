...
public class ChatListServlet extends HttpServlet {
	...
	public String getTen(String fromID, String toID) throws NamingException, SQLException {
	...
	public String getID(String fromID, String toID, String chatID) throws NamingException, SQLException {
		StringBuffer result = new StringBuffer();
		result.append("{\"result\":[");
